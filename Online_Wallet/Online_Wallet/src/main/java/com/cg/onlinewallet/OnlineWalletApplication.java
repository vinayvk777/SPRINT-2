...
public class OnlineWalletApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception{
		...
		em.persist(wa2);
		em.persist(wa3);
		WalletUser user1=new WalletUser("Vinay", "123", "876543", "email@ab.com",type.user,  wa1);
		WalletUser user2=new WalletUser("kumar", "1234", "8765432", "email@abc.com",type.user,  wa2);
		WalletUser user3=new WalletUser("singh", "12345", "87654321", "email@abcd.com",type.user,  wa3);
		em.persist(user1);
		em.persist(user2);
		em.persist(user3);
